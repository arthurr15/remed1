...
<body>
  ...
  $sqlquery = "SELECT * FROM showroom_arthur_table WHERE id_mobil = $id";
        ...
        echo "
                ...
                <div class='d-flex justify-content-center align-items-start gap-5 mt-5'>
                  ...
                  <form>
                    ...
                    <a href='Edit-Arthur.php?id=" . $detail["id_mobil"] . "' class='btn btn-primary' style='margin-top: 40px;'>Edit</a>
                  </form>
                </div>
            ";
      }
